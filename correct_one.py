...
# تحميل البيانات
info = pd.read_csv("D:\hager\graduation\disease_info.csv", encoding="latin1")
sup = pd.read_csv("D:\hager\graduation\supplement_info.csv")
...
file_id = "1b-bLmq_tK8zLMDnvTu5ez6VMUAW0Qq1U"
